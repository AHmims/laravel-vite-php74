...
it('respects TagGenerator overrides in development', function () {
    ...
    expect(vite()->getTags())
        ...
        ->toContain(
            '<script type="module" src="http://localhost:3000/entrypoints/multiple-with-css/main.ts" crossorigin></script>'
        )
        ->toContain(
            '<link rel="stylesheet" href="http://localhost:3000/entrypoints/multiple-with-css/style.css" crossorigin />'
        );
});
...
it('respects TagGenerator callback overrides in development', function () {
    ...
    expect(vite()->getTags())
        ...
        ->toContain(
            '<script type="module" src="http://localhost:3000/entrypoints/multiple-with-css/main.ts" crossorigin="anonymous"></script>'
        )
        ->toContain(
            '<link rel="stylesheet" href="http://localhost:3000/entrypoints/multiple-with-css/style.css" crossorigin="anonymous" />'
        );
...
it('respects TagGenerator overrides in production', function () {
    ...
    expect(using_manifest('builds/public/with-css/manifest.json')->getTags())
        ...
        ->toContain(
            '<script type="module" src="http://localhost/with-css/assets/test.a2c636dd.js" crossorigin></script>'
        );
});
...
it('uses integrity attributes when the chunk contains them', function () {
    ...
    expect(using_manifest('builds/public/with-integrity/manifest.json')->getTags())
        ...
        ->toContain(
            '<script type="module" src="http://localhost/with-integrity/assets/main.a2c636dd.js" integrity="sha384-2A5vUNf7cFDCWm6RTDPAnr/wmGjkQhXz4EP5keVPYX4OnI2Ws1iXgTQ70CTmC1Ux" crossorigin="anonymous"></script>'
        )
        ->toContain(
            '<link rel="stylesheet" href="http://localhost/with-integrity/assets/style.6b73f2d0.css" integrity="sha384-HmlJ0WJXVNLaqWQYVRhZgsW1JBN4XBjm3j+j38nagNFimvBxi8nZ1FUysAc9JJvL" crossorigin="anonymous" />'
        );
});
